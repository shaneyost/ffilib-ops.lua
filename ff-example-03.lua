...
---
--- - Why would would place `__attribute__((__packed__))` at the end vs at the
---   beginning (i.e. after `typdef struct`)? Whats the significance here and
---   can we write out an example showing casing why. This will help us
---   remember why.
---
